...
{
  readBadChannels_ = true;//ps.getParameter<bool>("readBadChannels");
  readBadChambers_ = true;//ps.getParameter<bool>("readBadChambers");
  useTimingCorrections_ = true;//ps.getParameter<bool>("CSCUseTimingCorrections");
  useGasGainCorrections_ = true;//ps.getParameter<bool>("CSCUseGasGainCorrections");
